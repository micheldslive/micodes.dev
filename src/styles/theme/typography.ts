...
export const typographyVariants = cva(
  "tracking-normal [font-variation-settings:'wght'_var(--font-wght),'wdth'_var(--font-wdth)]",
  {
    variants: {
      filling: {
        outline:
          'text-transparent [-webkit-text-stroke:1px_var(--color-slate-500)] max-lg:[-webkit-text-stroke:1px_var(--color-slate-500)] dark:[-webkit-text-stroke:1px_var(--color-slate-300)] max-lg:dark:[-webkit-text-stroke:1px_var(--color-slate-300)]',
